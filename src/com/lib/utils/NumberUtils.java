...
public class NumberUtils {
	/**
	 * When false, the mask in {@link #intToFloatColor(int)} will not be used.
	 * This must only be used when the resulting floats will not be used with
	 * {@link #floatToIntColor(float)}.
	 */
	...
	public static float intToFloatColor(int value) {
		return Float.intBitsToFloat(intToFloatColorMask ? (value & 0xfeffffff)
				: value);
	}
